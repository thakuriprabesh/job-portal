...
export function AiShortlisting() {
  ...
  const fetchApplicants = async (jobId) => {
    try {
      ...
      const extractedShortlisterData = response.data?.data.map(
        (applicant) => applicant.shortlisterData
      );
      setDataArray(extractedShortlisterData);
    } catch (error) {
  ...
  const handleEvaluate = async () => {
    try {
      ...
      const sortedApplicants = scoredApplicants.sort(
        (a, b) => b.score - a.score
      );

      console.log("All results in order:", resultArray);
      console.log("Applicants:", applicants);
      console.log("sortedApplicants:", sortedApplicants);
      setApplicants(sortedApplicants);
      toast.success("Applicants shorlisting successful.");
    } catch (error) {
      console.error("API call failed:", error);
      toast.error("Error shortlisting Applicants");
    }
  };
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-primary">AI Shortlisting</h1>
